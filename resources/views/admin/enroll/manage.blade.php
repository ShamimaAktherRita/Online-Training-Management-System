        ...
        <div class="col-md-12 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h3 class="float-start">Manage Enrolls</h3>
                </div>
                <div class="card-body">
                    <table id="courseTable" class="table table-striped w-100 nowrap">
                        ...
                        @foreach($enrolls as $enroll)
                            <tr>
                                ...
                                <td>{{ $enroll->status == 0 ? 'Rejected' : ''}}
                                    {{ $enroll->status == 1 ? 'Pending' : ''}}
                                    {{ $enroll->status == 2 ? 'Approved' : ''}}
                                </td>
                                <td>
                                    <a href="" class="btn btn-success btn-sm"><i class="uil-arrow-circle-up"></i></a>
                                    <a href="" class="btn btn-danger btn-sm"><i class="uil-arrow-circle-down"></i></a>
